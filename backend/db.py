...
def _get_dynamodb_resource():
    ...
    _dynamodb_resource = resource("dynamodb", **_session_config())
    return _dynamodb_resource
...
async def init_db():
    """Create and cache the shared boto3 DynamoDB resource."""
    return _get_dynamodb_resource()


async def close_db():
    """Keep the shared boto3 resource available for warm invocations."""
